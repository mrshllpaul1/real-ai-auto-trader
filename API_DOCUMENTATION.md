...
**Version:** 1.0.0  
**Base URL:** `https://code-improver-71.preview.emergentagent.com/api`  
...
```bash
curl -X POST "https://code-improver-71.preview.emergentagent.com/api/api-keys/create" \
...
```bash
curl -X GET "https://code-improver-71.preview.emergentagent.com/api/portfolio/summary" \
...
class TradingAPI:
    def __init__(self, api_key):
        self.base_url = "https://code-improver-71.preview.emergentagent.com/api"
...
class TradingAPI {
  constructor(apiKey) {
    this.baseURL = 'https://code-improver-71.preview.emergentagent.com/api';
    this.apiKey = apiKey;
  }
