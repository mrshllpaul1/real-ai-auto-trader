...
**Version:** 1.0.0  
**Base URL:** `https://status-checkup.preview.emergentagent.com/api`  
...
```bash
curl -X POST "https://status-checkup.preview.emergentagent.com/api/api-keys/create" \
...
```bash
curl -X GET "https://status-checkup.preview.emergentagent.com/api/portfolio/summary" \
...
class TradingAPI:
    def __init__(self, api_key):
        self.base_url = "https://status-checkup.preview.emergentagent.com/api"
...
class TradingAPI {
  constructor(apiKey) {
    this.baseURL = 'https://status-checkup.preview.emergentagent.com/api';
    this.apiKey = apiKey;
  }
