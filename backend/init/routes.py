...
def register_routes(api_router: APIRouter):
    ...
    from routes import enhanced_historical as enhanced_historical_routes
    ...
    api_router.include_router(enhanced_historical_routes.router, prefix="/enhanced-historical", tags=["Enhanced Historical Data"])
