...
def _get_sample_strategies() -> List[Dict]:
    """Generate sample marketplace strategies"""
    return [
        {
            "strategy_id": "strat_001",
            "name": "Momentum Master",
            "description": "High-probability momentum strategy with RSI and MACD confluence",
            "strategy_type": "momentum",
            "timeframe": "4h",
            "coins": ["BTC", "ETH", "SOL"],
            "price_monthly": 29.99,
            "creator": {"name": "AlgoTrader", "verified": True},
            "performance": {
                "total_return": 156.8,
                "win_rate": 68.5,
                "sharpe_ratio": 2.4,
            ...
            "tags": ["proven", "medium-risk", "swing-trading"]
        },
        {
            "strategy_id": "strat_002",
            "name": "DeFi Degen Alpha",
            "description": "Aggressive altcoin strategy targeting DeFi tokens with strong fundamentals",
            "strategy_type": "trend_following",
            "timeframe": "1d",
            "coins": ["AAVE", "UNI", "LINK", "MKR"],
            "price_monthly": 49.99,
            "creator": {"name": "DeFiWhale", "verified": True},
            "performance": {
                "total_return": 234.5,
                "win_rate": 62.1,
                "sharpe_ratio": 1.9,
            ...
            "tags": ["high-risk", "defi", "altcoins"]
        },
        {
            "strategy_id": "strat_003",
            "name": "BTC Accumulator",
            "description": "Conservative DCA strategy with smart entry points",
            "strategy_type": "dca",
            "timeframe": "1w",
            "coins": ["BTC"],
            "price_monthly": 0,
            "creator": {"name": "BTCMaxi", "verified": False},
            "performance": {
                "total_return": 45.2,
                "win_rate": 75.0,
                "sharpe_ratio": 1.5,
            ...
            "tags": ["free", "low-risk", "beginner-friendly", "btc-only"]
        },
        {
            ...
            "coins": ["BTC", "ETH"],
            "price_monthly": 19.99,
            "creator": {"name": "StatArb", "verified": True},
            "performance": {
                "total_return": 89.3,
                "win_rate": 71.2,
                "sharpe_ratio": 2.1,
            ...
            "subscribers_count": 756,
            "avg_rating": 4.4,
            "reviews_count": 45,
            "status": "active",
            "created_at": "2024-09-01T00:00:00Z",
            "tags": ["scalping", "high-frequency", "medium-risk"]
        },
        {
            "strategy_id": "strat_005",
            "name": "AI Signal Follower",
            "description": "ML-powered strategy using ensemble predictions",
            "strategy_type": "ai_ml",
            "timeframe": "4h",
            "coins": ["BTC", "ETH", "SOL", "AVAX"],
            "price_monthly": 99.99,
            "creator": {"name": "QuantLab", "verified": True},
            "performance": {
                "total_return": 312.7,
                "win_rate": 65.8,
                "sharpe_ratio": 2.8,
            ...
            "tags": ["ai", "premium", "high-performance"]
        }
    ]
