...
const PAGES = [
  ...
  { name: 'AI Copilot', path: '/ai-copilot', icon: Bot, category: 'AI', keywords: 'ai copilot chat assistant help trading' },
  { name: 'NL Strategy Builder', path: '/nl-strategy', icon: Wand2, category: 'AI', keywords: 'natural language strategy builder create' },
  { name: 'ML Analytics', path: '/ml-analytics', icon: Activity, category: 'AI', keywords: 'ml analytics drift calibration ab test' },
