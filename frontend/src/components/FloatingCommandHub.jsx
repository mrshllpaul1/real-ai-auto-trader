      ...
      <AnimatePresence>
        {!isOpen && (
          <motion.button
            ...
            className="fixed bottom-4 right-4 z-50 w-14 h-14 rounded-full bg-gradient-to-br from-cyan-500 via-purple-500 to-pink-500 shadow-lg shadow-purple-500/30 hover:shadow-xl hover:shadow-purple-500/40 transition-all flex items-center justify-center group"
        ...
        {isOpen && (
          <motion.div
            ...
            className={`fixed z-50 bg-slate-900/95 backdrop-blur-xl border border-slate-700/50 rounded-2xl shadow-2xl shadow-black/50 overflow-hidden flex flex-col ${
              isMinimized ? 'bottom-4 right-4 w-72 h-12' : 'bottom-4 right-4 w-[95vw] sm:w-[420px] h-[75vh] sm:h-[550px] max-h-[85vh]'
            }`}
