...
const Sidebar = () => {
  ...
  const navItems = [
    ...
    { path: '/trading', icon: Wallet, label: 'Trading', highlight: true },
    { path: '/ai', icon: Brain, label: 'AI & Strategy', highlight: true },
    { path: '/backtest', icon: BarChart3, label: 'Backtest', highlight: true },
    { path: '/news', icon: Newspaper, label: 'News & Events', highlight: true },
    { path: '/scanner', icon: Radar, label: 'Scanner & Social', highlight: true },
    { path: '/defi', icon: Sprout, label: 'DeFi', highlight: true },
