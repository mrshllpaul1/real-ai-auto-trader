...
const Sidebar = () => {
  ...
  const navItems = [
    ...
    { path: '/live-dashboard', icon: Radio, label: 'Live Dashboard' },
    { path: '/trading', icon: Wallet, label: 'Trading' },
    { path: '/ai', icon: Brain, label: 'AI & Strategy' },
    { path: '/ai-copilot', icon: MessageCircle, label: 'AI Copilot' },
    { path: '/nl-strategy', icon: Wand2, label: 'NL Strategy Builder' },
    { path: '/ml-analytics', icon: Activity, label: 'ML Analytics' },
