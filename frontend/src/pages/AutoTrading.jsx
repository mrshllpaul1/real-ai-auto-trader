...
const WeeklySchedulerSection = () => {
  ...
  const executeSelection = async () => {
    try {
      ...
      if (res.data.success) {
        toast.success(`Executed ${res.data.trades_count} trades! Total: $${res.data.(total_invested ?? 0).toFixed(2) || 0}`);
        await loadSchedulerData();
      }
    } catch (error) {
      toast.dismiss();
              ...
              <div className="mt-3 pt-3 border-t border-[#333]">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-sm">
                    ...
                    <span className="text-[#00FF94] font-medium">${latestSelection.execution_result.(total_invested ?? 0).toFixed(2) || 0}</span>
                  </div>
