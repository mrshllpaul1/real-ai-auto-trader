      ...
      {dashboard && (
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
          ...
          <div className="bg-[#1F1F1F]/50 border border-[#333] rounded-xl p-4">
            ...
            <p className="text-2xl font-bold text-white">{dashboard.summary?.total_predictions_today?.toLocaleString()}</p>
          </div>
          <div className="bg-[#1F1F1F]/50 border border-[#333] rounded-xl p-4">
          ...
          <div className="bg-[#1F1F1F]/50 border border-[#333] rounded-xl p-4">
            ...
            <p className="text-2xl font-bold text-[#9D00FF]">{dashboard.summary?.avg_sharpe_24h?.toFixed(2)}</p>
          </div>
        </div>
      )}
