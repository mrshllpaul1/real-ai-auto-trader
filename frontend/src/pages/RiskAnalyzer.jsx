              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#A1A1AA]">
                    Portfolio: ${overview.total_portfolio_value?.toLocaleString()}
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="p-3 bg-[#0A0A0A] border border-[#333] rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-[#00FF94] font-bold">
                      ${overview.risk_breakdown?.perpetuals?.total_exposure?.toLocaleString() || 0}
                    </span>
                  </div>
                  <div className="grid grid-cols-3 gap-2 text-sm">
                    ...
                    <div>
                      ...
                      <p className="text-white">
                        ${overview.risk_breakdown?.perpetuals?.long_exposure?.toLocaleString() || 0} / 
                        ${overview.risk_breakdown?.perpetuals?.short_exposure?.toLocaleString() || 0}
                      </p>
                    </div>
                    <div>
                ...
                <div className="p-3 bg-[#0A0A0A] border border-[#333] rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-[#9D00FF] font-bold">
                      ${overview.risk_breakdown?.yield_farming?.total_exposure?.toLocaleString() || 0}
                    </span>
                  </div>
                  <div className="grid grid-cols-3 gap-2 text-sm">
                    <div>
                    ...
                    <div>
                      ...
                      <p className="text-white">${overview.risk_breakdown?.yield_farming?.il_exposure?.toLocaleString() || 0}</p>
                    </div>
                    <div>
                      <p className="text-[#A1A1AA]">High Risk</p>
                      <p className="text-white">${overview.risk_breakdown?.yield_farming?.high_risk_exposure?.toLocaleString() || 0}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-3 bg-[#0A0A0A] border border-[#333] rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-[#FF9500] font-bold">
                      ${overview.risk_breakdown?.options?.total_exposure?.toLocaleString() || 0}
                    </span>
                  </div>
                  <div className="grid grid-cols-4 gap-2 text-sm">
                    <div>
                      <p className="text-[#A1A1AA]">Delta</p>
                      <p className="text-white">{overview.risk_breakdown?.options?.net_delta?.toFixed(2) || 0}</p>
                    </div>
                    <div>
                      <p className="text-[#A1A1AA]">Gamma</p>
                      <p className="text-white">{overview.risk_breakdown?.options?.net_gamma?.toFixed(4) || 0}</p>
                    </div>
                    <div>
          ...
          >
                  ...
                  <div key={i} className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <div className="flex justify-between mb-1">
                        ...
                        <span className="text-[#A1A1AA]">${asset.total?.toLocaleString()}</span>
                      </div>
            ...
            <div className="lg:col-span-2 grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="bg-[#1F1F1F]/50 border border-[#333] rounded-xl p-4 text-center">
                ...
                <p className="text-2xl font-bold text-[#00FF94]">${exposure.by_type?.perpetuals?.toLocaleString() || 0}</p>
              </div>
              <div className="bg-[#1F1F1F]/50 border border-[#333] rounded-xl p-4 text-center">
                <p className="text-sm text-[#A1A1AA]">Yield Farming</p>
                <p className="text-2xl font-bold text-[#9D00FF]">${exposure.by_type?.yield_farming?.toLocaleString() || 0}</p>
              </div>
              <div className="bg-[#1F1F1F]/50 border border-[#333] rounded-xl p-4 text-center">
                <p className="text-sm text-[#A1A1AA]">Options</p>
                <p className="text-2xl font-bold text-[#FF9500]">${exposure.by_type?.options?.toLocaleString() || 0}</p>
              </div>
            </div>
          </motion.div>
        )}
            ...
            <div className="bg-[#1F1F1F]/50 border border-[#333] rounded-xl p-6">
              ...
              <div className="space-y-4">
                <div className="p-4 bg-[#0A0A0A] border border-[#333] rounded-lg">
                  ...
                  <p className="text-3xl font-bold text-red-400">${varData.var_95?.toLocaleString()}</p>
                ...
                <div className="p-4 bg-[#0A0A0A] border border-[#333] rounded-lg">
                  ...
                  <p className="text-3xl font-bold text-red-500">${varData.var_99?.toLocaleString()}</p>
                  <p className="text-xs text-[#A1A1AA] mt-1">
                ...
                <div className="p-4 bg-[#0A0A0A] border border-[#333] rounded-lg">
                  ...
                  <p className="text-3xl font-bold text-red-600">${varData.expected_shortfall?.toLocaleString()}</p>
                  <p className="text-xs text-[#A1A1AA] mt-1">
            ...
            <div className="bg-[#1F1F1F]/50 border border-[#333] rounded-xl p-6">
              ...
              <div className="space-y-4">
                <div className="flex justify-between p-3 bg-[#0A0A0A] border border-[#333] rounded-lg">
                  ...
                  <span className="text-white font-bold">${varData.portfolio_value?.toLocaleString()}</span>
                </div>
                <div className="flex justify-between p-3 bg-[#0A0A0A] border border-[#333] rounded-lg">
            ...
            <div className="lg:col-span-2 bg-[#1F1F1F]/50 border border-[#333] rounded-xl p-6">
              ...
              <div className="relative h-32 bg-[#0A0A0A] rounded-lg overflow-hidden">
                ...
                <div className="absolute bottom-2 left-4 text-xs text-white">
                  99% VaR: ${varData.var_99?.toLocaleString()}
                </div>
                <div className="absolute bottom-2 left-24 text-xs text-white">
                  95% VaR: ${varData.var_95?.toLocaleString()}
                </div>
              </div>
                ...
                <div className={`p-6 rounded-xl border ${
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-xl font-bold text-white">${stressTest.current_portfolio_value?.toLocaleString()}</p>
                    </div>
                    <div>
                      ...
                      <p className={`text-xl font-bold ${stressTest.total_impact >= 0 ? 'text-[#00FF94]' : 'text-red-400'}`}>
                        ${stressTest.projected_portfolio_value?.toLocaleString()}
                      </p>
                    </div>
                    <div>
                      <p className="text-sm text-[#A1A1AA]">Total Impact</p>
                      <p className={`text-xl font-bold ${stressTest.total_impact >= 0 ? 'text-[#00FF94]' : 'text-red-400'}`}>
                        {stressTest.total_impact >= 0 ? '+' : ''}${stressTest.total_impact?.toLocaleString()}
                      </p>
                    </div>
                    <div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-3 bg-[#0A0A0A] border border-[#333] rounded-lg">
                      ...
                      <span className={`font-bold ${stressTest.impact_breakdown?.perpetuals >= 0 ? 'text-[#00FF94]' : 'text-red-400'}`}>
                        {stressTest.impact_breakdown?.perpetuals >= 0 ? '+' : ''}${stressTest.impact_breakdown?.perpetuals?.toLocaleString()}
                      </span>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-[#0A0A0A] border border-[#333] rounded-lg">
                      <span className="text-[#A1A1AA] flex items-center gap-2">
                      ...
                      <span className={`font-bold ${stressTest.impact_breakdown?.yield_farming >= 0 ? 'text-[#00FF94]' : 'text-red-400'}`}>
                        {stressTest.impact_breakdown?.yield_farming >= 0 ? '+' : ''}${stressTest.impact_breakdown?.yield_farming?.toLocaleString()}
                      </span>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-[#0A0A0A] border border-[#333] rounded-lg">
                      <span className="text-[#A1A1AA] flex items-center gap-2">
                      ...
                      <span className={`font-bold ${stressTest.impact_breakdown?.options >= 0 ? 'text-[#00FF94]' : 'text-red-400'}`}>
                        {stressTest.impact_breakdown?.options >= 0 ? '+' : ''}${stressTest.impact_breakdown?.options?.toLocaleString()}
                      </span>
                    </div>
                  </div>
